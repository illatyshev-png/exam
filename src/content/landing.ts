...
export const heroContent = {
  headline:
    "Избегайте ошибок 70% провалившихся: получите готовые конспекты по 350+ вопросам и симулятор экзамена уже сегодня",
  subheadline:
...
export const authorityContent = {
  headline: "Меня зовут Илья Латышев. В декабре 2025 я сам готовился к экзамену по этим же материалам и сдал его!",
  groups: [
    {
...
export const pricingContent = {
  headline: "Самый доступный вариант подготовки",
  subheadline:
    "Провал экзамена стоит вам 6 месяцев простоя в ожидании пересдачи. Подготовка — от 99 руб./мес. Что выбираете?",
  footnote:
...
export const footerContent = {
  copyright: `© ${new Date().getFullYear()} Частное предприятие «Юридическая компания Ильи Латышева». УНП 192023334`,
  links: [
    {
      label: "Публичная оферта на конспекты",
    ...
    {
      label: "Публичная оферта на бота",
